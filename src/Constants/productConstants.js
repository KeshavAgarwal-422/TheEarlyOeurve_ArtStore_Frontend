...
export const ALL_FEATUREDPRODUCT_REQUEST = "ALL_FEATUREDPRODUCT_REQUEST";
export const ALL_FEATUREDPRODUCT_SUCCESS = "ALL_FEATUREDPRODUCT_SUCCESS";
export const ALL_FEATUREDPRODUCT_FAIL = "ALL_FEATUREDPRODUCT_FAIL";

export const ALL_PAINTING_REQUEST = "ALL_PAINTING_REQUEST";
export const ALL_PAINTING_SUCCESS = "ALL_PAINTING_SUCCESS";
export const ALL_PAINTING_FAIL = "ALL_PAINTING_FAIL";

export const ALL_DRAWING_REQUEST = "ALL_DRAWING_REQUEST";
export const ALL_DRAWING_SUCCESS = "ALL_DRAWING_SUCCESS";
export const ALL_DRAWING_FAIL = "ALL_DRAWING_FAIL";

export const ALL_SCULPTURE_REQUEST = "ALL_SCULPTURE_REQUEST";
export const ALL_SCULPTURE_SUCCESS = "ALL_SCULPTURE_SUCCESS";
export const ALL_SCULPTURE_FAIL = "ALL_SCULPTURE_FAIL";
